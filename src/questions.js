export default {
    ...
    "d0bca746-f7e8-430f-827f-165b83758177": {
        ...
        question: "Which one is a valid link definitions?",
        answers: [
    ...
    "a56abb5d-612d-4105-9505-6db7e8f1d23c": {
        ...
        question: "Which one is a valid image definitions?",
        answers: [
            {
                text:
    ...
    "7a65931c-8d52-4e4c-a7e3-295c94da8a69": {
        ...
        question: "Which one is a valid attribute for <img> elements?",
        answers: [
            { text: "src" },
            { text: "target" },
            { text: "description" },
    ...
    "e8f018b6-d8a0-4b83-9a45-fd5106019c19": {
        ...
        question: "Which one is a valid stylesheet definition?",
        answers: [
    ...
    "e5e695e4-d02b-4577-851a-9d6a1b75ba14": {
        ...
        question: "Which one is a valid color definition?",
        answers: [
            { text: "#ff00" },
            { text: "rgba(0, 0, 0)" },
            { text: "rgba(0, 0, 0, 0.5)" }
